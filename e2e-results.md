...
| 20 | e2e-calendar-booking | ✅ Done | | 🔧 | 21 | | Mixed | Test Code + App Code | 2/3 | will | 26/47 confirmed ✅; 21 🚧 Blocked (AI quota exhausted — Gemini 2.5 Flash 20 req/day free tier). Fixes: setupIntegration→API; sendMessage stability-polling; route catch→console.error; DeepSeek→Gemini default. Re-run after topping up any AI provider. | Top up an AI provider (Anthropic/OpenAI/DeepSeek) or wait until tomorrow for Gemini quota reset, then re-run blocked AI widget tests | 2026-04-04 |
