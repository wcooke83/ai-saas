            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full rounded-md border border-secondary-200 dark:border-secondary-700 bg-white dark:bg-secondary-800 px-3 py-2 text-sm"
                >
...
.chat-widget-container {
                ...
                className="w-full h-32 rounded-md border border-secondary-200 dark:border-secondary-700 bg-white dark:bg-secondary-800 px-3 py-2 font-mono text-sm"
              />
            </CardContent>
          </Card>
        </div>
