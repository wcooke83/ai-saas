...
const tools = [
  ...
  },
  {
    ...
    description: 'Automatically summarize meetings, extract action items, and generate follow-up tasks.',
    icon: MessageSquare,
    href: '#',
    badge: 'Coming Soon',
    category: 'Productivity',
    features: ['Audio transcription', 'Action items', 'Key points extraction'],
    available: false,
  },
];

const categories = ['All', 'Communication', 'Sales', 'Social Media', 'Analytics', 'Automation', 'Content', 'Productivity'];
...
export default function ToolsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-secondary-50 to-white dark:from-secondary-950 dark:to-secondary-900">
      {/* Header */}
      <header className="border-b border-secondary-200 dark:border-secondary-800 bg-white/80 dark:bg-secondary-900/80 backdrop-blur-sm sticky top-0 z-40">
      ...
      <main>
        ...
        <section className="container mx-auto px-4 py-16 text-center">
          ...
          <p className="text-lg text-secondary-600 dark:text-secondary-400 max-w-2xl mx-auto mb-8">
            Explore our growing suite of AI tools designed to help you work smarter.
            From emails to proposals, we&apos;ve got you covered.
          </p>
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="rounded-2xl bg-primary-500 p-8 md:p-12 text-center text-white max-w-4xl mx-auto">
