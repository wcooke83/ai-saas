        ...
        {activeTab === 'components' && (
          <div className="space-y-8">
            ...
            <section>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg">Toast Variants</CardTitle>
                  <CardDescription>Non-blocking notifications using Sonner. Click buttons to preview.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    <h3 className="font-medium text-secondary-900 dark:text-secondary-100">With Description</h3>
                    <div className="flex flex-wrap gap-3">
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => toast.success('File uploaded', {
                          description: 'Your document has been uploaded and is ready to view.',
                        })}
                      >
                        With Description
                      </Button>
                  ...
                  <div>
                    <h3 className="font-medium text-secondary-900 dark:text-secondary-100 mb-2">Usage</h3>
