...
import type { SocialPostResult } from '@/lib/ai/prompts/social-post';

function SocialPostEmbed() {
  ...
  useEffect(() => {
    ...
    if (window.parent !== window) {
      window.parent.postMessage(
        { source: 'ai-saas-embed', type: 'ready', toolId: 'social-post' },
        '*'
      );
    }
  ...
  const handleGenerate = (result: SocialPostResult) => {
...
export default function SocialPostEmbedPage() {
  return (
