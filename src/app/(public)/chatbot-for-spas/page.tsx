...
const faqLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What can VocUI's AI chatbot do for Spas?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Let an AI chatbot handle treatment bookings, pricing FAQs, and after-hours enquiries for your spa \u2014 24/7. Keep your therapists focused on clients, not the phone."
      }
    },
    {
      "@type": "Question",
      "name": "How long does it take to set up VocUI for Spas?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Most Spas get set up in under an hour. Upload your existing content -- service descriptions, FAQs, pricing pages, or PDFs -- and VocUI trains the chatbot automatically. Embed it on your website with a single snippet."
      }
    },
    {
      "@type": "Question",
    ...
    {
      "@type": "Question",
      "name": "How is VocUI different from a generic chatbot for Spas?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Unlike generic chatbots, VocUI is trained exclusively on your own content -- your service descriptions, policies, FAQs, and documents. It only answers questions relevant to your Spas business and escalates to your team when it cannot help, with full conversation context included."
      }
    }
  ]
};
