...
const faqLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can the chatbot explain the difference between treatment types and help clients choose?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Upload your treatment menu with descriptions — Swedish massage vs deep tissue, facial types, body treatments — and the chatbot guides clients to the right option for their needs."
      }
    },
    {
      "@type": "Question",
      "name": "Will VocUI book spa appointments?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, via Easy!Appointments. Clients can book treatments, couples packages, and spa days directly from the chat, including evenings when they're planning ahead."
      }
    },
    {
      "@type": "Question",
      "name": "Can the chatbot answer questions about spa packages and gift vouchers?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Train it on your package inclusions, seasonal offers, and gift voucher options — and it answers these questions automatically, reducing reception workload on busy weekends."
      }
    },
    {
      "@type": "Question",
      "name": "How does the chatbot handle health declaration and contraindication questions?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You can include standard contraindication information in your knowledge base. The chatbot explains which conditions may affect treatment suitability and directs clients to confirm with your therapist team before booking."
      }
    }
  ]
};
      ...
      <main id="main-content">
        <nav aria-label="Breadcrumb" className="container mx-auto px-4 pt-6 pb-2">
          <ol className="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400">
            ...
            <li aria-hidden="true">/</li>
            <li className="text-secondary-900 dark:text-secondary-100 font-medium">AI Chatbot for Spas</li>
          </ol>
        </nav>
        ...
        <section id="how-it-works" className="bg-secondary-50 dark:bg-secondary-800/30 py-24">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-16"><Badge variant="outline" className="mb-4">How it works</Badge><h2 className="text-3xl font-bold text-secondary-900 dark:text-secondary-100">Live before your next treatment booking. No developers needed.</h2></div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-10">
                <Badge variant="outline" className="mb-4">How spas use VocUI</Badge>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {[
                  { step: 'Before', text: 'Evening visitors browsing treatment menus and gift voucher options with no one available to answer — converting to bookings at a competitor who had a faster response.' },
                  { step: 'Setup', text: 'Uploaded their treatment guide, pricing menu, gift voucher FAQ, and booking policy — live without development work in under an hour.' },
                  { step: 'After', text: 'Treatment and pricing questions answered after hours. Evening and weekend enquiries converted to bookings automatically. Therapists focused on treatments, not admin.' },
                ].map((item) => (
