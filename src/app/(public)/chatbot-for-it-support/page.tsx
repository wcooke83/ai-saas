...
const faqLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can the chatbot handle first-line IT support queries?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Upload your known issues documentation, standard fixes, and IT policy FAQ — and the chatbot handles first-line queries automatically, deflecting tickets that don't require engineer involvement."
      }
    },
    {
      "@type": "Question",
      "name": "Will VocUI integrate with our existing helpdesk or ticketing system?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "VocUI captures the issue and routes it to your team with full context. For direct ticketing system integrations, this typically involves your team's escalation workflow rather than a native connector."
      }
    },
    {
      "@type": "Question",
      "name": "Can the chatbot answer questions about software access, password resets, and account setup?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, if you upload your standard IT procedures for these requests. It walks users through self-service steps and escalates requests that require engineer action."
      }
    },
    {
      "@type": "Question",
      "name": "How does VocUI handle out-of-hours IT incidents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You configure escalation rules. For critical incidents — system outages, security events — the chatbot surfaces your on-call contact immediately. For standard requests outside hours, it captures the details for first-thing-morning resolution."
      }
    }
  ]
};
...
const breadcrumbLd = {
  ...
  "itemListElement": [
    ...
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "AI Chatbot for IT Support Teams",
      "item": "https://vocui.com/chatbot-for-it-support"
    }
  ]
};
      ...
      <main id="main-content">
        <nav aria-label="Breadcrumb" className="container mx-auto px-4 pt-6 pb-2">
          <ol className="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400">
            ...
            <li aria-hidden="true">/</li>
            <li className="text-secondary-900 dark:text-secondary-100 font-medium">AI Chatbot for IT Support Teams</li>
          </ol>
        </nav>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-10">
                <Badge variant="outline" className="mb-4">How IT support teams use VocUI</Badge>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {[
                  { step: 'Before', text: 'Engineers burning the first hours of each week clearing a ticket queue full of password resets, VPN setup questions, and software access requests — the same issues every time.' },
                  { step: 'Setup', text: 'Uploaded their IT self-service guide, common issue FAQ, software access request process, and escalation policy — configured in-house without external help.' },
                  { step: 'After', text: 'Tier-1 questions handled automatically, any time. Ticket queue dominated by issues that actually need engineering attention. Response SLAs easier to meet.' },
                ].map((item) => (
