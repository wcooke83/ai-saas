      ...
      <div className="relative z-10 flex flex-col flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        >
          ...
          >
            ...
            <span className="text-primary-500">build and deploy.</span>
          </motion.h1>
          ...
          >
            Guides, tutorials, and references to help you get the most out of
            VocUI — from first chatbot to production deployment.
          </motion.p>
        </motion.div>
      </div>
