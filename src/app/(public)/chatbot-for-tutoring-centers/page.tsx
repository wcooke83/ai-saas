...
const faqLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can the chatbot answer questions about subjects, age groups, and tutoring formats?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Upload your subject list, age range FAQ, and session format descriptions — online vs in-person, one-to-one vs group — and the chatbot answers these questions before a parent calls."
      }
    },
    {
      "@type": "Question",
      "name": "Will VocUI book tutoring sessions or assessment appointments?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, via Easy!Appointments. Parents can book initial assessments, trial sessions, and ongoing tutoring directly from the chat."
      }
    },
    {
      "@type": "Question",
      "name": "Can the chatbot explain your approach to exam preparation and curriculum alignment?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Upload your methodology overview, exam board alignment, and results FAQ — and the chatbot communicates your approach to parents researching tutoring options at any hour."
      }
    },
    {
      "@type": "Question",
      "name": "How does VocUI handle progress and reporting enquiries from parents?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Upload your reporting schedule and progress review process. For specific student progress questions, the chatbot escalates to the relevant tutor — ensuring parents get the right information without the admin burden falling on your team."
      }
    }
  ]
};
      ...
      <main id="main-content">
        ...
        <section id="how-it-works" className="bg-secondary-50 dark:bg-secondary-800/30 py-24">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-16"><Badge variant="outline" className="mb-4">How it works</Badge><h2 className="text-3xl font-bold text-secondary-900 dark:text-secondary-100">Live before your next enrolment enquiry. No developers needed.</h2></div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-10">
                <Badge variant="outline" className="mb-4">How tutoring centers use VocUI</Badge>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {[
                  { step: 'Before', text: 'Parents emailing in the evening about subject availability, tutor qualifications, and pricing — and enrolling with a competitor centre by the time the team replied the next day.' },
                  { step: 'Setup', text: 'Uploaded their subject and tutor guide, pricing FAQ, enrolment process, and timetable overview — live on their website that evening.' },
                  { step: 'After', text: 'Evening and weekend enquiries answered automatically. Parents get the information they need to enrol without waiting. Tutors start each week with a fuller timetable.' },
                ].map((item) => (
