          ...
          <article>
            <header className="mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <time dateTime="2025-12-19" className="text-xs text-secondary-400 dark:text-secondary-500">Dec 19, 2025</time>
          ...
          <div className="mt-10 mb-2 rounded-xl border border-secondary-200 dark:border-secondary-700 bg-secondary-50 dark:bg-secondary-800/50 p-6">
            ...
            <ul className="space-y-3">
              <li>
                ...
                <p className="text-sm text-secondary-500 dark:text-secondary-400 mt-0.5">Reservations, menus, allergen FAQs, and hours automation — purpose-built for hospitality.</p>
              </li>
            </ul>
          </div>
          {/* CTA */}
