                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="bg-secondary-50 dark:bg-secondary-800/60">
                        ...
                        <th className="text-left px-4 py-3 font-semibold text-secondary-900 dark:text-secondary-100">Free plan limits</th>
                        <th className="text-center px-4 py-3 font-semibold text-secondary-900 dark:text-secondary-100">Live chat</th>
                        <th className="text-center px-4 py-3 font-semibold text-secondary-900 dark:text-secondary-100">AI chatbot</th>
                        <th className="text-center px-4 py-3 font-semibold text-secondary-900 dark:text-secondary-100">Ecommerce</th>
                        <th className="text-center px-4 py-3 font-semibold text-secondary-900 dark:text-secondary-100">Mobile app</th>
                      </tr>
                    </thead>
