          ...
          <article>
            <header className="mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <time dateTime="2026-03-30" className="text-xs text-secondary-400 dark:text-secondary-500">Mar 30, 2026</time>
          ...
          <div className="mt-10 mb-2 rounded-xl border border-secondary-200 dark:border-secondary-700 bg-secondary-50 dark:bg-secondary-800/50 p-6">
            ...
            <ul className="space-y-3">
              <li>
                ...
                <p className="text-sm text-secondary-500 dark:text-secondary-400 mt-0.5">Find your industry — from restaurants and dentists to logistics and non-profits.</p>
              </li>
            </ul>
          </div>
          {/* CTA */}
