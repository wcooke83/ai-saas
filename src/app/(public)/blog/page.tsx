...
const posts: BlogPost[] = [
  ...
  // ─── Batch 3b: Industry Use Cases (new) ──────────────────────────────────────
  {
    slug: 'chatbot-for-real-estate',
    title: 'AI Chatbot for Real Estate: Qualifying Buyers, Booking Viewings, and Capturing Vendor Leads',
    description: 'How real estate agencies use AI chatbots to qualify buyer enquiries, book property viewings automatically, and capture vendor valuation leads — 24/7.',
    readTime: '9 min read',
    tag: 'Use Case',
    datePublished: '2026-04-02',
  },
  {
    slug: 'chatbot-for-healthcare',
    title: 'AI Chatbot for Healthcare: Answering Patient Questions Without Giving Medical Advice',
    description: 'How healthcare providers use AI chatbots to reduce administrative phone volume, answer patient FAQs, and book appointments — while keeping clinical questions with clinical staff.',
    readTime: '9 min read',
    tag: 'Use Case',
    datePublished: '2026-04-02',
  },
  {
    slug: 'chatbot-for-hr',
    title: 'AI Chatbot for HR Teams: Answering Policy Questions and Onboarding New Starters at Scale',
    description: 'How HR teams use internal AI chatbots to answer staff policy questions, guide new starter onboarding, and reduce repetitive enquiries — without adding headcount.',
    readTime: '9 min read',
    tag: 'Use Case',
    datePublished: '2026-04-02',
  },
  {
    slug: 'chatbot-for-plumbers',
    title: 'AI Chatbot for Plumbers: Handling Emergency Calls, Booking Jobs, and Quoting Common Work',
    description: 'How plumbing businesses use AI chatbots to handle after-hours emergency enquiries, book routine jobs, and answer common pricing questions — without missing a single call.',
    readTime: '8 min read',
    tag: 'Use Case',
    datePublished: '2026-04-02',
  },
  {
    ...
    title: 'AI Chatbot for Ecommerce: Deflecting Support Tickets and Answering Pre-Purchase Questions',
    description: 'How ecommerce stores use AI chatbots to deflect repetitive support tickets, answer product questions before purchase, and handle returns enquiries — without scaling headcount.',
    readTime: '9 min read',
    tag: 'Use Case',
    datePublished: '2026-04-02',
  },
  {
    ...
    title: 'AI Chatbot for Hotels: Answering Guest Questions and Handling Booking Enquiries 24/7',
    description: 'How hotels use AI chatbots to answer pre-arrival questions, handle group booking enquiries, and surface amenity information — freeing front desk staff for in-house guests.',
    readTime: '9 min read',
    tag: 'Use Case',
    datePublished: '2026-04-02',
  },
