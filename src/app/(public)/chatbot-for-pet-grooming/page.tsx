...
const faqLd = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Can the chatbot explain grooming packages and what's included for different breeds?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Upload your service menu with breed-specific notes — coat types, typical groom duration, what's included in a full groom vs a bath and brush — and the chatbot answers the pre-booking questions you field every day."
      }
    },
    {
      "@type": "Question",
      "name": "Will VocUI book pet grooming appointments?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, via Easy!Appointments. Pet owners can book their next appointment directly from the chat, at any hour — reducing the phone calls you take before and after opening."
      }
    },
    {
      "@type": "Question",
      "name": "Can the chatbot answer questions about first-time groom preparation?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Upload your first-time groom guide — what to expect, how to prepare your dog, what the process involves — and the chatbot shares it automatically with new clients who ask."
      }
    },
    {
      "@type": "Question",
      "name": "How does VocUI handle questions about pet health conditions that affect grooming?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It can share your general health and grooming policy. For specific conditions — skin problems, anxiety, post-surgery restrictions — the chatbot escalates to you rather than attempting to advise."
      }
    }
  ]
};
      ...
      <main id="main-content">
        <nav aria-label="Breadcrumb" className="container mx-auto px-4 pt-6 pb-2">
          <ol className="flex items-center gap-2 text-sm text-secondary-500 dark:text-secondary-400">
            ...
            <li aria-hidden="true">/</li>
            <li className="text-secondary-900 dark:text-secondary-100 font-medium">AI Chatbot for Pet Grooming</li>
          </ol>
        </nav>
        ...
        <section id="how-it-works" className="bg-secondary-50 dark:bg-secondary-800/30 py-24">
          <div className="container mx-auto px-4">
            <div className="text-center max-w-2xl mx-auto mb-16"><Badge variant="outline" className="mb-4">How it works</Badge><h2 className="text-3xl font-bold text-secondary-900 dark:text-secondary-100">Live before your next grooming appointment. No developers needed.</h2></div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-10">
                <Badge variant="outline" className="mb-4">How pet grooming salons use VocUI</Badge>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                {[
                  { step: 'Before', text: 'Groomers interrupted repeatedly throughout the day to answer calls about pricing, availability, breed-specific services, and what to bring — while dogs were waiting to be groomed.' },
                  { step: 'Setup', text: 'Uploaded their services and pricing guide, breed FAQ, booking policy, and preparation instructions — configured in an afternoon.' },
                  { step: 'After', text: 'Pricing and availability questions handled automatically. Phone interruptions during sessions significantly reduced. Appointments booked online with the right information already collected.' },
                ].map((item) => (
