      ...
      <div className="relative z-10 flex flex-col flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        >
          ...
          >
            ...
            <span className="text-primary-500">No exceptions.</span>
          </motion.h1>
          ...
          >
            End-to-end encryption, isolated account data, GDPR and CCPA compliance, and a strict
            zero-training policy on your content. Security is built in from day one — on every plan.
          </motion.p>
