...
export interface WidgetTranslations {
  ...
  handoffConnectedToAgent: string;
  defaultAgentName: string;
  agentTyping: string;
  removeAttachment: string;
  maxFilesLabel: string;
  handoffDescribeLabel: string;
  // Feedback follow-up
...
export const WIDGET_TRANSLATIONS: Record<string, WidgetTranslations> = {
  en: {
    ...
    handoffConnecting: 'Connecting to agent...',
    handoffConnectedToAgent: 'Connected to agent',
    defaultAgentName: 'Agent',
    agentTyping: 'Agent is typing',
    removeAttachment: 'Remove',
    maxFilesLabel: 'Max {count} files',
    handoffDescribeLabel: 'Describe what you need help with',
  ...
  es: {
    ...
    handoffConnecting: 'Conectando con un agente...',
    handoffConnectedToAgent: 'Conectado con un agente',
    defaultAgentName: 'Agente',
    agentTyping: 'El agente está escribiendo',
    removeAttachment: 'Eliminar',
    maxFilesLabel: 'Máx. {count} archivos',
    handoffDescribeLabel: 'Describe con qué necesitas ayuda',
  ...
  fr: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Connexion à un agent...',
    handoffConnectedToAgent: 'Connecté à un agent',
    defaultAgentName: 'Agent',
    agentTyping: "L'agent est en train d'écrire",
    removeAttachment: 'Supprimer',
    maxFilesLabel: 'Max {count} fichiers',
    handoffDescribeLabel: "Décrivez ce pour quoi vous avez besoin d'aide",
  ...
  de: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Verbindung mit Agent...',
    handoffConnectedToAgent: 'Mit Agent verbunden',
    defaultAgentName: 'Agent',
    agentTyping: 'Agent schreibt',
    removeAttachment: 'Entfernen',
    maxFilesLabel: 'Max. {count} Dateien',
    handoffDescribeLabel: 'Beschreiben Sie, wobei Sie Hilfe benötigen',
  ...
  pt: {
    ...
    // Escalation / Report
    flagIssue: 'Sinalizar um problema',
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Conectando ao agente...',
    handoffConnectedToAgent: 'Conectado ao agente',
    defaultAgentName: 'Agente',
    agentTyping: 'O agente está digitando',
    removeAttachment: 'Remover',
    maxFilesLabel: 'Máx. {count} arquivos',
    handoffDescribeLabel: 'Descreva com o que precisa de ajuda',
  ...
  it: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: "Connessione all'agente...",
    handoffConnectedToAgent: "Connesso all'agente",
    defaultAgentName: 'Agente',
    agentTyping: "L'agente sta scrivendo",
    removeAttachment: 'Rimuovi',
    maxFilesLabel: 'Max {count} file',
    handoffDescribeLabel: 'Descrivi di cosa hai bisogno',
  ...
  nl: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Verbinden met agent...',
    handoffConnectedToAgent: 'Verbonden met agent',
    defaultAgentName: 'Agent',
    agentTyping: 'Agent is aan het typen',
    removeAttachment: 'Verwijderen',
    maxFilesLabel: 'Max {count} bestanden',
    handoffDescribeLabel: 'Beschrijf waar u hulp bij nodig heeft',
  ...
  ru: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Подключение к агенту...',
    handoffConnectedToAgent: 'Подключено к агенту',
    defaultAgentName: 'Агент',
    agentTyping: 'Агент печатает',
    removeAttachment: 'Удалить',
    maxFilesLabel: 'Макс. {count} файлов',
    handoffDescribeLabel: 'Опишите, с чем вам нужна помощь',
  ...
  zh: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: '正在连接客服...',
    handoffConnectedToAgent: '已连接客服',
    defaultAgentName: '客服',
    agentTyping: '客服正在输入',
    removeAttachment: '移除',
    maxFilesLabel: '最多 {count} 个文件',
    handoffDescribeLabel: '描述您需要什么帮助',
  ...
  ja: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'エージェントに接続中...',
    handoffConnectedToAgent: 'エージェントに接続済み',
    defaultAgentName: 'エージェント',
    agentTyping: 'エージェントが入力中',
    removeAttachment: '削除',
    maxFilesLabel: '最大 {count} ファイル',
    handoffDescribeLabel: 'どのようなサポートが必要か説明してください',
  ...
  ko: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: '상담원 연결 중...',
    handoffConnectedToAgent: '상담원 연결됨',
    defaultAgentName: '상담원',
    agentTyping: '상담원이 입력 중',
    removeAttachment: '제거',
    maxFilesLabel: '최대 {count}개 파일',
    handoffDescribeLabel: '어떤 도움이 필요한지 설명해 주세요',
  ...
  ar: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'جاري الاتصال بالوكيل...',
    handoffConnectedToAgent: 'متصل بالوكيل',
    defaultAgentName: 'وكيل',
    agentTyping: 'الوكيل يكتب',
    removeAttachment: 'إزالة',
    maxFilesLabel: 'الحد الأقصى {count} ملفات',
    handoffDescribeLabel: 'صف ما تحتاج المساعدة فيه',
  ...
  hi: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'एजेंट से कनेक्ट हो रहा है...',
    handoffConnectedToAgent: 'एजेंट से जुड़ा हुआ',
    defaultAgentName: 'एजेंट',
    agentTyping: 'एजेंट टाइप कर रहा है',
    removeAttachment: 'हटाएं',
    maxFilesLabel: 'अधिकतम {count} फ़ाइलें',
    handoffDescribeLabel: 'बताएं कि आपको किस सहायता की आवश्यकता है',
  ...
  tr: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Temsilciye bağlanılıyor...',
    handoffConnectedToAgent: 'Temsilciye bağlandı',
    defaultAgentName: 'Temsilci',
    agentTyping: 'Temsilci yazıyor',
    removeAttachment: 'Kaldır',
    maxFilesLabel: 'Maks. {count} dosya',
    handoffDescribeLabel: 'Neye yardım istediğinizi açıklayın',
  ...
  pl: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Łączenie z agentem...',
    handoffConnectedToAgent: 'Połączono z agentem',
    defaultAgentName: 'Agent',
    agentTyping: 'Agent pisze',
    removeAttachment: 'Usuń',
    maxFilesLabel: 'Maks. {count} plików',
    handoffDescribeLabel: 'Opisz, w czym potrzebujesz pomocy',
  ...
  sv: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Ansluter till agent...',
    handoffConnectedToAgent: 'Ansluten till agent',
    defaultAgentName: 'Agent',
    agentTyping: 'Agenten skriver',
    removeAttachment: 'Ta bort',
    maxFilesLabel: 'Max {count} filer',
    handoffDescribeLabel: 'Beskriv vad du behöver hjälp med',
  ...
  no: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Kobler til agent...',
    handoffConnectedToAgent: 'Koblet til agent',
    defaultAgentName: 'Agent',
    agentTyping: 'Agenten skriver',
    removeAttachment: 'Fjern',
    maxFilesLabel: 'Maks {count} filer',
    handoffDescribeLabel: 'Beskriv hva du trenger hjelp med',
  ...
  da: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Forbinder til agent...',
    handoffConnectedToAgent: 'Forbundet til agent',
    defaultAgentName: 'Agent',
    agentTyping: 'Agenten skriver',
    removeAttachment: 'Fjern',
    maxFilesLabel: 'Maks {count} filer',
    handoffDescribeLabel: 'Beskriv hvad du har brug for hjælp til',
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'Yhdistetään agenttiin...',
    handoffConnectedToAgent: 'Yhdistetty agenttiin',
    defaultAgentName: 'Agentti',
    agentTyping: 'Agentti kirjoittaa',
    removeAttachment: 'Poista',
    maxFilesLabel: 'Enintään {count} tiedostoa',
    handoffDescribeLabel: 'Kuvaile mihin tarvitset apua',
  ...
  th: {
    ...
    handoffInactivityWarning: 'Are you still there? This conversation will close soon due to inactivity.',
    handoffInactivityClosed: 'This conversation was closed due to inactivity. Feel free to start a new chat!',
    handoffConnecting: 'กำลังเชื่อมต่อกับเจ้าหน้าที่...',
    handoffConnectedToAgent: 'เชื่อมต่อกับเจ้าหน้าที่แล้ว',
    defaultAgentName: 'เจ้าหน้าที่',
    agentTyping: 'เจ้าหน้าที่กำลังพิมพ์',
    removeAttachment: 'ลบ',
    maxFilesLabel: 'สูงสุด {count} ไฟล์',
    handoffDescribeLabel: 'อธิบายสิ่งที่คุณต้องการความช่วยเหลือ',
