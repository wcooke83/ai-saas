---
name: ai-endpoint
description: Generate API endpoints for AI integrations with Claude/OpenAI, streaming support, and usage tracking. Use when creating AI-powered features or chatbots.
---
