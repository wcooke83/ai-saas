---
name: api-route
description: Scaffold Next.js API routes with auth, validation, rate limiting, and error handling. Use when creating new API endpoints, webhooks, or streaming routes.
---
